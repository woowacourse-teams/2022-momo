...
Request
include::{snippets}/userimageupload/http-request.adoc[]

Response
include::{snippets}/userimageupload/http-response.adoc[]

=== 유저 이미지 불러오기

Request
include::{snippets}/userimageload/http-request.adoc[]

Response
include::{snippets}/userimageload/http-response.adoc[]

=== 모임 이미지 업로드

Request
include::{snippets}/groupimageupload/http-request.adoc[]

Response
include::{snippets}/groupimageupload/http-response.adoc[]

=== 모임 이미지 불러오기

Request
include::{snippets}/groupimageload/http-request.adoc[]

Response
include::{snippets}/groupimageload/http-response.adoc[]
