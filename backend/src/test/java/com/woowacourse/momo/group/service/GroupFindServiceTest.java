...
class GroupFindServiceTest {
    ...
    void findParticipatedGroups() {
        ...
        List<Group> actual = groupFindService.findParticipatedGroups(request, host).getContent();
    ...
    void findHostedGroups() {
        ...
        List<Group> actual = groupFindService.findHostedGroups(request, host).getContent();
