...
insert into momo_group(category, deadline, description, enddate, startdate, hostid, location, name)
values ('ETC', '2022-07-21 23:59', '주말에 같이 야구 보실 분 구합니다.\n외야 쪽 좌석으로 잡을 예정이고 두산이나 엘지 팬이시면 좋겠습니다.\n편하게 연락주세여 ⚾',
...
insert into momo_group(category, deadline, description, enddate, startdate, hostid, location, name)
values ('ETC', '2022-07-23 23:59', '안녕하세요! 목요일에 같이 영화보러가요 🎞🎞',
