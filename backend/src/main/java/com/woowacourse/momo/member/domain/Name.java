...
import static com.woowacourse.momo.global.exception.exception.ErrorCode.MEMBER_NAME_SHOULD_NOT_BE_BLACK;
...
public class Name {
    ...
    private void validateNameIsNotBlank() {
        if (value.isBlank()) {
            throw new MomoException(MEMBER_NAME_SHOULD_NOT_BE_BLACK);
        }
    }
