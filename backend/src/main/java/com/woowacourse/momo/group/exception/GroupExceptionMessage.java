...
public enum GroupExceptionMessage implements ExceptionMessage {
    ...
    GROUP_ALREADY_CLOSED_EARLY("해당 모임은 이미 조기 마감되었습니다."),
    ...
    HOST_CANNOT_PARTICIPATE_OR_LEAVE_OWN_GROUP("주최자는 자신의 모임에 참여 또는 탈퇴할 수 없습니다."),

    MEMBER_IS_NOT_HOST("모임의 주최자가 아닙니다."),
